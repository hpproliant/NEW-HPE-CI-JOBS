...
sudo -E stestr -vvv --debug --log-file /home/citest/gate_logs/tox.logs run --serial ironic_standalone.test_basic_ops.BaremetalIloDirectWholediskHttpLink.test_ip_access_to_server
